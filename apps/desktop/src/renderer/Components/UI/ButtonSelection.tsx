...
export const ButtonSelection = ({ options, active, onSelect, columns, className }: ButtonSelectionProps) => (
	<div
		...
		{options.map((option) => (
			<button
				...
				className={cn(
					...
					option === active ? "bg-text-primary text-surface" : "text-text-secondary hover:text-text-primary",
				)}
				aria-label={option}
			>
				{option}
